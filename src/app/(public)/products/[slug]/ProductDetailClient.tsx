            ...
            <div className="space-y-6">
              ...
              <div className="flex items-center gap-4">
                <div className="flex items-center gap-2">
                  ...
                  <span
                    className={`text-3xl font-bold ${product.originalPrice ? "text-brand-red" : "text-brand-dark"}`}
                  >
              ...
              <div className="space-y-4">
                <div>
                  ...
                  <p className="text-brand-gray text-sm leading-relaxed">
                    {product.description} This premium sneaker features
                    high-quality materials and craftsmanship, designed for both
                    comfort and style. Perfect for everyday wear with its
                    versatile design that complements any outfit.
                  </p>
                </div>
                <div>
                  <h3 className="font-semibold text-brand-dark mb-2">
                  ...
                  <p className="text-brand-gray text-sm">
                    True to size. If you are between sizes, we recommend sizing
                    up for better comfort. Refer to our size guide for accurate
                    measurements.
                  </p>
                </div>
                <div>
                  ...
                  <p className="text-brand-gray text-sm">
                    Upper: Premium synthetic material. Sole: Durable rubber.
                    Care: Wipe clean with a damp cloth. Do not machine wash. Air
