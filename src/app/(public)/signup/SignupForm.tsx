      ...
      >
        ...
        <form className="mt-8 space-y-5" onSubmit={handleSubmit(onSubmit)}>
          <div className="space-y-4">
            {/* Name Field */}
            <div>
              <label htmlFor="name" className="block text-xs font-semibold text-brand-dark uppercase tracking-wider mb-2">
                Full Name
              </label>
              <div className="relative">
                <div className="pointer-events-none absolute inset-y-0 left-0 flex items-center pl-3">
                  <User className="h-4 w-4 text-brand-dark/45" />
                </div>
                <input
                  id="name"
                  type="text"
                  ...
                  className={`form-field pl-10 ${
                    errors.name ? "border-brand-red focus:border-brand-red focus:ring-brand-red/20" : ""
                  }`}
            ...
            <div>
              <label htmlFor="confirmPassword" className="block text-xs font-semibold text-brand-dark uppercase tracking-wider mb-2">
                Confirm Password
              </label>
              <div className="relative">
                <div className="pointer-events-none absolute inset-y-0 left-0 flex items-center pl-3">
                ...
                <input
                  ...
                  autoComplete="new-password"
                  className={`form-field pl-10 pr-10 ${
                    errors.confirmPassword ? "border-brand-red focus:border-brand-red focus:ring-brand-red/20" : ""
                  }`}
                  placeholder="••••••••"
                  disabled={isLoading}
